...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light ">
    <a class="navbar-brand" href="home.php"><img id=""src="img/indice.jpg" title="Inicio" width="30px" height="30px" class="" ></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li>
          <a id="l1"class=" nav-link" href="view_proceso.php"> Nuevo</a>
        </li>
        ...
        <li class="nav-item"> 
          <a class="nav-link" href="view_dicenarHorario.php"  >Horarios</a>
        </li>
    ...
    <div class="nav-item ml-4">
     ...
     <div class="nav-item ml-4" >
          <a  class="nav-link text-success" href="logout.php" title="Cerrar sesión"><i class="fas fa-power-off" style="font-size:20px;" ></i></a>
      </div>
  </nav>
